 ...
 */
@Component
public class Judge implements SubjectTypeAdapter{
    @Resource
    ...
    public Boolean add(SubjectBO subjectBO) {
        ...
        List<SubjectJudge> subjectJudgeList = Lists.newArrayList();
        subjectBO.getOptionList().forEach(e->{
            ...
            subjectJudge.setIsCorrect(e.getIsCorrect());
    ...
    public SubjectOptionBo query(Long subjectId) {
        LambdaQueryWrapper<SubjectJudge> queryWrapper = new LambdaQueryWrapper<>();
        queryWrapper.eq(SubjectJudge::getSubjectId,subjectId);
        List<SubjectJudge> subjectJudgeList = subjectJudgeService.list(queryWrapper);
        // subjectJudgeList 转 SubjectOptionBo
        List<SubjectAnswerBO> subjectAnswerBOList = SubjectDomainConverter.INSTANCE.subjectJudgeListToSubjectAnswerBOList(subjectJudgeList);
