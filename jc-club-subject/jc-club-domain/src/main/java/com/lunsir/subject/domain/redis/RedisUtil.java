package com.lunsir.subject.domain.redis;
...
public class RedisUtil {
    ...
    /**
     * Redis中的reverseRangeWithScores函数用于获取有序集合（Zset）中的成员，
     * 这些成员按照分数值递减（从大到小）的顺序排列。
     * 该函数返回一个Set集合，包含了有序集合中指定范围内的所有成员及其分数
     * @param key
     * @param start
     * @param end
     * @return
    ...
    public void decrement(String key,Long count){
