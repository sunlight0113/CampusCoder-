...
public class SubjectCategoryDomainConverterImpl implements SubjectCategoryDomainConverter {

    @Override
    public SubjectCategory convertBoToSubjectCategory(SubjectCategoryBO subjectCategoryBO) {
    ...
    @Override
    public List<SubjectCategoryBO> convertToSubjectCategoryBOList(List<SubjectCategory> subjectCategoryList) {
